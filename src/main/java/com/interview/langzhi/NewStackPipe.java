 ...
 */
public class NewStackPipe<T> implements Iterable<T>, Serializable {
    // 声明序列化版本ID
...
//            }
    ...
    public static <E> NewStackPipe<E> create(Collection<? extends E> c) {
        NewStackPipe<E> pipe = new NewStackPipe<>();
...
//        stackPipe.push(2);
//        stackPipe.push(3);
        NewStackPipe<Integer> newStackPipe = NewStackPipe.create(Arrays.asList(1, 2, 3));
        ...
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(tempFilePath))) {
            oos.writeObject(newStackPipe);
        }
        // 反序列化
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(tempFilePath))) {
            @SuppressWarnings("unchecked")
            NewStackPipe<Integer> deserializedStack = (NewStackPipe<Integer>) ois.readObject();
        ...
        for (Integer num : newStackPipe) {
            System.out.println(num);
        }
        System.out.println();

        System.out.println("===== 栈翻转 =====");
        newStackPipe.reverse();
        newStackPipe.printStack();
        ...
        System.out.println("中间节点: " + newStackPipe.findMiddle());
        System.out.println();
        ...
        System.out.println("pop() -> " + newStackPipe.pop());

        // POP2取数验证, 期望输出1
        System.out.println("队列元素验证:");
        System.out.println("pop2() -> " + newStackPipe.pop2());
